                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="{{route('cardthree.create')}}" class="cardthree_create"  enctype="multipart/form-data">
                                                {{csrf_field()}}
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="{{route('cardthree.edit.new')}}" class="cardthree_edit"  enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                {{method_field('PATCH')}}
                                                <div class="form-group">
                                    ...
                                    @if(Auth::user() && (Auth::user()->partition_id == 1 || Auth::user()->partition_id == 3))
                                        ...
                                        <td>
                                            <div class="m-btn-group m-btn-group--pill btn-group m-btn-group m-btn-group--pill btn-group-sm" role="group" aria-label="First group">
                                                <button  onclick="getCardThree({{$i->id}})"  type="button" data-toggle="modal" data-target="#slider_edit" class="m-btn btn btn-primary">
                                                    <i class="flaticon-edit-1"></i>
                                                </button>

                                                <button  data-cardthree="{{$i->id}}"  type="button" data-toggle="modal" data-target="#confirmModal" class="delete1 m-btn btn btn-danger">
...
<script>
    ...
    <script>
        ...
        function getCardThree($id) {
            $item_card=$id;
            $.get('{{route('cardthree.edit.new')}}',{item_card:$item_card},function(data){
        ...
        $(".delete1").click(function(event){
            ...
            if (r == true) {
                $.get('{{route('cardthree.destroy.new')}}', {item_card: $item_card}, function (data) {
                    if (data.status == true) {
                        alert("jjhjhjh");
