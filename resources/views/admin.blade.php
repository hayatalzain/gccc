...
<head>
    ...
    <link href="{{asset('assets/vendors/custom/demo/style.bundle.css')}}" rel="stylesheet" type="text/css" />
    <!--end::Page Vendors -->
                                            ...
                                            <div class="m-dropdown__body">
                                                <div class="m-dropdown__content">
                                                    <ul class="m-nav m-nav--skin-light">
                                                        ...
                                                        <li class="m-nav__separator m-nav__separator--fit"></li>
                                                        <li class="m-nav__item">
                                                            <a href="{{route('home.logout')}}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">
                                                                Logout
                                                            </a>
                                                            @auth

                                                                @if(Auth::user() && (Auth::user()->partition_id == 1))
                                                            <a href="{{route('register')}}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" style="
    float: right;
">
                                                                Register
                                                            </a>
            ...
            >
                <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover">
                        <a href="{{route('cardthree')}}" class="m-menu__link">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover">
                        <a  href="{{route('sponsors')}}" class="m-menu__link">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1">
                        <a  href="{{route('features')}}" class="m-menu__link">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1">
                        <a  href="{{route('email')}}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1">
                        <a  href="{{route('conference')}}" class="m-menu__link">
                            <span class="m-menu__item-here"></span>
...
<script src="{{asset('assets/vendors/custom/datatables/select2.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/vendors/custom/paginations/paginations.js')}}" type="text/javascript"></script>
<!--end::Page Vendors -->
<!--begin::Page Snippets -->
<script src="{{asset('assets/app/js/dashboard.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/toaster/toaster.js')}}" type="text/javascript"></script>
@yield("js")
    <script>
        WebFont.load({
...
<script>
    ...
    {{--function loader() {--}}
        {{--$('.btn-primary').append('<img src="{{asset('images/loader4.gif')}}" width="35" height="35" >')--}}
    {{--}--}}
