            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo e(route('features.create')); ?>" class="features_create"  enctype="multipart/form-data">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="<?php echo e(route('features.edit.new')); ?>" class="features_edit"  enctype="multipart/form-data">
                                                <?php echo e(csrf_field()); ?>
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"  id="m_table_12">
                                ...
                                <tr id="row_features<?php echo e($i->id); ?>">
                                    ...
                                    <div class="m-btn-group m-btn-group--pill btn-group m-btn-group m-btn-group--pill btn-group-sm" role="group" aria-label="First group">
                                        <button onclick="getFeatures(<?php echo e($i->id); ?>)" type="button" data-toggle="modal" data-target="#slider_edit" class="m-btn btn btn-primary">
                                            <i class="flaticon-edit-1"></i>
                                        </button>

                                        <button  data-features="<?php echo e($i->id); ?>" type="button" data-toggle="modal" data-target="#confirmModal" class="delete1 m-btn btn btn-danger">
...
<script>
    ...
    function getFeatures($id) {
        $item_features=$id;
        $.get('<?php echo e(route('features.edit.new')); ?>',{item_features:$item_features},function(data){
    ...
    $(".delete1").click(function(event){
        ...
        if (r == true) {
            $.get('<?php echo e(route('features.destroy.new')); ?>', {item_features: $item_features}, function (data) {
                if (data.status == true) {
