            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form method="POST" action="<?php echo e(route('slider.create')); ?>" class="slider_create"  enctype="multipart/form-data">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="<?php echo e(route('slider.edit.new')); ?>" class="slider_edit"  enctype="multipart/form-data">
                                                <?php echo e(csrf_field()); ?>
            ...
            <div class="m_datatable m-datatable m-datatable--default m-datatable--error m-datatable--scroll m-datatable--loaded" id="m_datatable_latest_orders" style="position: static; zoom: 1;">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable"  id="m_table_12">
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="row_slider<?php echo e($i->id); ?>">
                            ...
                            <td id="type_cont_<?php echo e($i->id); ?>"><?php echo e($i->type); ?></td>
                            <td id="read_more_cont_<?php echo e($i->id); ?>"><?php echo e($i->read_more); ?></td>
                            ...
                            <td>
                                <div class="m-btn-group m-btn-group--pill btn-group m-btn-group m-btn-group--pill btn-group-sm" role="group" aria-label="First group">
                                    <button onclick="getSlider(<?php echo e($i->id); ?>)" type="button" data-toggle="modal" data-target="#slider_edit" class="m-btn btn btn-primary">
                                        <i class="flaticon-edit-1"></i>
                                    </button>

                                    <button data-slider="<?php echo e($i->id); ?>" type="button" data-toggle="modal" data-target="#confirmModal" class="delete1 m-btn btn btn-danger">
...
<script>
    ...
    <script>
        ...
        function getSlider($id) {
            $item_slider=$id;
            $.get('<?php echo e(route('slider.edit.new')); ?>',{item_slider:$item_slider},function(data){
        ...
        $(".delete1").click(function(event){
            ...
            if (r == true) {
                $.get('<?php echo e(route('slider.destroy.new')); ?>', {item_slider: $item_slider}, function (data) {
                    if (data.status == true) {
